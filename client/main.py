...
Note: I assumed that the constant variables `WINDOW_SIZE`, `GAME_SIZE`, `CTB_HIGHT`, `ETB_HIGHT`, `BTN_HIGHT`, and `UI_SIZE` are defined elsewhere in the code and remain unchanged.
